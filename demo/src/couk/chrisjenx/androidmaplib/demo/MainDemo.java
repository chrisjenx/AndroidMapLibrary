...
public class MainDemo extends ListActivity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		String path = intent.getStringExtra("couk.chrisjenx.androidmaplib.demo.Path");
	...
	{
		Intent result = new Intent();
		result.setClass(this, MainDemo.class);
		result.putExtra("couk.chrisjenx.androidmaplib.demo.Path", path);
		return result;
	}
